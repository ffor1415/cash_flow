...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    if (error) { toast.error(error.message); } else { toast.success('Password updated!'); navigate('/'); }
  };

  return (
    <div className="min-h-dvh bg-background flex flex-col items-center justify-center overflow-x-hidden">
